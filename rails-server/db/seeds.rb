...
items = Item.create([
  ...
  {name: 'Shetland Salmon portions', size: '140g - 170g',grade: 'Superior', is_frozen: false, price_by_each: true, price_per: '3.00', min: "1", max: "100", fresh: 'fresh' },
  {name: 'Shetland Salmon whole sides filleted', size: '1.5kg - 2.0kg',grade: 'Superior', is_frozen: false, price_by_each: false, price_per: '14.95', min: "1", max: "100", fresh: 'fresh' },
  {name: 'Grimsby Haddock fillets', size: '170g - 200g',grade: 'Superior', is_frozen: false, price_by_each: true, price_per: '3.00', min: "1", max: "100", fresh: 'fresh' },
  {name: 'Devon hake portions', size: '140g - 170g',grade: 'Superior', is_frozen: false, price_by_each: true, price_per: '3.00', min: "1", max: "100", fresh: 'fresh' },
  {name: 'Devon hake whole side fillets', size: '500g - 1kg',grade: 'Superior', is_frozen: false, price_by_each: false, price_per: '15.95', min: "1", max: "100", fresh: 'fresh' },
  {name: 'Brixham wild bass (small)', size: '600g - 1kg',grade: 'Hook and Line', is_frozen: false, price_by_each: false, price_per: '16.95', min: "1", max: "100", fresh: 'fresh' },
